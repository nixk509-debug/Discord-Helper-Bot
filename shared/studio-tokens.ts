...
export const STUDIO_TOKEN_DEFINITIONS: StudioTokenDefinition[] = [
  {
    ...
    aliases: ["{username}", "{user}", "{user.name}", "{user.displayName}"],
    category: "identity",
  ...
  },
  {
    ...
    label: "Server",
    primaryAlias: "{server}",
    aliases: ["{server}", "{server.name}", "{server_name}"],
    category: "server",
  ...
  },
  {
    ...
    aliases: ["{server_id}", "{server.id}", "{guild_id}"],
    category: "server",
    requiredContext: "static",
  ...
  },
  {
    ...
    aliases: ["{member_count}", "{server.membercount}", "{server.memberCount}"],
    category: "server",
    requiredContext: "static",
    previewSample: "1,248",
  ...
  },
  {
    ...
    aliases: ["{channel_mention}", "{channel.mention}"],
    category: "channel",
    requiredContext: "static",
    previewSample: "#announcements",
  ...
  },
  {
    ...
    aliases: ["{message_link}", "{message.link}"],
    category: "message",
    requiredContext: "post_send",
