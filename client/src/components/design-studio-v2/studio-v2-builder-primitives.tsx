  ...
  return (
    <section className="overflow-hidden rounded-[18px] border border-white/[0.08] bg-[linear-gradient(180deg,rgba(10,10,16,0.99),rgba(5,5,9,1))] shadow-[0_16px_40px_rgba(0,0,0,0.36)]">
      ...
      <div className="space-y-3 px-3 py-3">
        {groups.map((group) => (
          <div key={group.id}>
            <p className="mb-1.5 px-1 text-[9px] font-bold uppercase tracking-[0.28em] text-white/25">{group.title}</p>
              ...
              <div className="space-y-1">
                {group.items.map((item) => (
                  <button
                    ...
                    className={cn(
                      "flex w-full items-center gap-2.5 rounded-[12px] border px-3 py-2 text-left transition",
                      item.selected
  ...
  return (
    <section className="space-y-3">
      ...
      <div className="space-y-3">
        {groups.map((group) => (
          <div key={group.id}>
            <p className="mb-1.5 px-0.5 text-[9px] font-bold uppercase tracking-[0.28em] text-white/25">{group.title}</p>
            <div className="grid gap-1.5 sm:grid-cols-2">
              {group.options.map((option) => (
                <button
                  ...
                  className={cn(
                    "group flex items-center gap-2.5 rounded-[13px] border px-3 py-2.5 text-left transition",
                    option.disabled
