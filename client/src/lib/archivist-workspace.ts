...
export const ARCHIVIST_NAVIGATION: ArchivistNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "creative-counting", section: "community", slug: "counting", label: "Counting", description: "Counting channels and cooperative game loops.", icon: "games", hiddenFromNav: true },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "settings-moderation", section: "operations", slug: "moderation", label: "Moderation", description: "Moderation behavior and staff control surfaces.", icon: "permissions", hiddenFromNav: true },
      { id: "settings-verification", section: "operations", slug: "verification", label: "Verification", description: "Verification state, access flow, and trust posture.", icon: "permissions", hiddenFromNav: true },
      ...
      { id: "settings-security", section: "operations", slug: "security-tools", label: "Security Tools", description: "Recovery posture, access safety, and protected operations.", icon: "permissions", hiddenFromNav: true },
