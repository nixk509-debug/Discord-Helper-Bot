...
export const ARCHIVIST_NAVIGATION: ArchivistNavSection[] = [
  ...
  },
  {
    ...
    icon: "games",
    items: [
      { id: "creative-overview", section: "fun", slug: "overview", label: "Overview", description: "See active community systems, quick wins, and the next creative lane.", icon: "overview" },
      ...
      { id: "creative-starboard", section: "fun", slug: "starboard", label: "Starboard", description: "Starboard highlights and featured posts.", icon: "games", hiddenFromNav: true },
      { id: "creative-reaction-roles", section: "fun", slug: "reaction-roles", label: "Reaction Roles", description: "Role pickup and community opt-in flows.", icon: "games", hiddenFromNav: true },
      { id: "creative-counting", section: "fun", slug: "counting", label: "Counting", description: "Counting channels and cooperative game loops.", icon: "games", hiddenFromNav: true },
      { id: "creative-media", section: "fun", slug: "media-greeting-effects", label: "Media / Greeting Effects", description: "Greeting media and lightweight presentation helpers.", icon: "games", hiddenFromNav: true },
      { id: "creative-events", section: "fun", slug: "community-events", label: "Community Events", description: "Recurring events and community energy tools.", icon: "games", hiddenFromNav: true },
    ],
  },
  {
    id: "server",
    ...
    icon: "settings",
    items: [
      { id: "settings-overview", section: "server", slug: "overview", label: "Overview", description: "Review moderation health, setup warnings, and the next system lane.", icon: "overview" },
      ...
      { id: "settings-moderation", section: "server", slug: "moderation", label: "Moderation", description: "Moderation behavior and staff control surfaces.", icon: "permissions", hiddenFromNav: true },
      { id: "settings-verification", section: "server", slug: "verification", label: "Verification", description: "Verification state, access flow, and trust posture.", icon: "permissions", hiddenFromNav: true },
      { id: "settings-tickets", section: "server", slug: "tickets", label: "Tickets", description: "Support surfaces and ticket system configuration.", icon: "settings", hiddenFromNav: true },
      { id: "settings-security", section: "server", slug: "security-tools", label: "Security Tools", description: "Recovery posture, access safety, and protected operations.", icon: "permissions", hiddenFromNav: true },
...
export const ARCHIVIST_TOOL_DRAWERS: Record<ArchivistCanonicalSection, ArchivistToolEntry[]> = {
  ...
  fun: [
    { id: "tool-leveling", section: "fun", slug: "profile", label: "Leveling", description: "Progression, XP visibility, and profile growth.", icon: "games", featured: true },
    { id: "tool-starboard", section: "fun", slug: "starboard", label: "Starboard", description: "Featured post and reaction spotlight flows.", icon: "games" },
    { id: "tool-reaction-roles", section: "fun", slug: "reaction-roles", label: "Reaction Roles", description: "Role pickup and member choice flows.", icon: "games" },
    { id: "tool-counting", section: "fun", slug: "counting", label: "Counting", description: "Counting channels and cooperative loops.", icon: "games" },
    { id: "tool-giveaways", section: "fun", slug: "creative-tools", label: "Giveaways", description: "Giveaways, events, and live moments.", icon: "games", featured: true },
    { id: "tool-leaderboards", section: "fun", slug: "leaderboards", label: "Leaderboards", description: "Rankings, wins, and visible competition.", icon: "games" },
    { id: "tool-media", section: "fun", slug: "media-greeting-effects", label: "Media / Greeting Effects", description: "Greeting effects and presentation helpers.", icon: "games" },
    { id: "tool-events", section: "fun", slug: "community-events", label: "Community Event Tools", description: "Recurring events and community energy tools.", icon: "games" },
  ],
  server: [
    { id: "tool-moderation", section: "server", slug: "moderation", label: "Moderation", description: "Moderation health and staff control surfaces.", icon: "permissions", featured: true },
    { id: "tool-verification", section: "server", slug: "verification", label: "Verification", description: "Verification posture and entry gating.", icon: "permissions", featured: true },
    { id: "tool-logs", section: "server", slug: "logging", label: "Logs", description: "Operational signals and failure history.", icon: "logs" },
    { id: "tool-tickets", section: "server", slug: "tickets", label: "Tickets", description: "Support flow configuration and handoff surfaces.", icon: "settings" },
    { id: "tool-permissions", section: "server", slug: "permissions", label: "Permissions", description: "Role and access logic for protected systems.", icon: "permissions" },
    { id: "tool-channels", section: "server", slug: "channels", label: "Channels", description: "Live channel structure and routing posture.", icon: "channels" },
    { id: "tool-roles", section: "server", slug: "roles", label: "Roles", description: "Role groups, hierarchy, and setup integrity.", icon: "roles" },
    { id: "tool-backups", section: "server", slug: "backups-sync", label: "Backup / Templates", description: "Recovery posture and migration staging.", icon: "backup" },
    { id: "tool-security", section: "server", slug: "security-tools", label: "Security Tools", description: "Access safety and protected operations.", icon: "permissions" },
  ],
};
